...
let sandwichMaker = () => {
  let order = "One sandwich with tomato"
          ...
          return function sandwich(food) {
            let newOrder = order + " and " + food
            return newOrder
          }
}

let sandwich = sandwichMaker(); // => returns a function    // initialises a child functions
...
// Another Sandwich:
let sandwich2 = sandwichMaker(); // => returns a function // initialises a child functions by a differnt name
